    ...
    <header className="sticky top-0 z-50 flex h-16 items-center border-b bg-background/90 pr-2 pl-4 backdrop-blur-md">
      ...
      <div className="flex items-center gap-2">
        <a
          ...
          target="_blank"
          rel="noopener"
          className="flex items-center gap-2.5 rounded-md bg-zinc-50 px-2.5 py-2 transition-colors duration-300 hover:bg-zinc-100 dark:bg-zinc-900 dark:hover:bg-zinc-800"
        >
          <svg
            viewBox="0 0 328 329"
            fill="none"
